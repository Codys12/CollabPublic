...
contract Storage{
    ...
    struct RewardData{
        ...
        uint256 entryNumber;
        uint256 proposalId; //Used for lookup in the originating reward contract
    ...
    (
        ...
        public
    {
        emit ProposalCreated(proposalId, projectIndex, identifier, msg.sender, rewardee);
    }
        ...
        returns (uint256 totalReward)
    {
        ...
        posts[postIndex].rewardData[msg.sender][identifier].proposalId = proposalId;
    ...
    function getIPFSCID(uint256 postIndex) public view returns (string memory){
    ...
    function getProposalIndex(uint256 postIndex, address uploader, uint256 identifier) public view returns (uint256){
        return posts[postIndex].rewardData[uploader][identifier].proposalId;
    }
